...
Please make sure that the following dependencies are met (installed) before
proceeding on Bookiza Abelone.
...
It is recommended to install the latest stable (it's free!) version of node
(v8.11.3 or higher as of writing this) directly from the [Nodes.js® website](https://nodejs.org/en/download/).
